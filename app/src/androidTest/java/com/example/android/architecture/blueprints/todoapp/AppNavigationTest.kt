...
@LargeTest
class AppNavigationTest : BaseEndToEndTest() {
    @Test
    fun tasksScreen_clickOnDrawerIcon_OpensNavigation() {
        ...
        activityScenario.clickDrawerIcon()
    ...
    fun taskDetailScreen_doubleUpButton() = runBlocking {
        ...
        onView(withId(R.id.tasks_list)).perform(
                RecyclerViewActions.actionOnItem<RecyclerView.ViewHolder>(hasDescendant(withText(title)), click())
        )
...
private fun ActivityScenario<TasksActivity>.clickDrawerIcon() {
